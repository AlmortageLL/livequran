...
LOGGER_ID = int(getenv("OWNER_ID","6753126490"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/CMG_5S")

SUPPORT_CHANNELL = getenv("SUPPORT_CHANNELL", "https://t.me/O_A_H2")
